...
def matrix_to_quaternion(M):
    ...
    q[mask1, 0] = 0.25 * S
    q[mask1, 1] = (M[mask1, 2, 1] - M[mask1, 1, 2]) / S
    q[mask1, 2] = (M[mask1, 0, 2] - M[mask1, 2, 0]) / S
    q[mask1, 3] = (M[mask1, 1, 0] - M[mask1, 0, 1]) / S
    
    # 处理其他情况需要更复杂的逻辑，为简洁起见，
    # 建议直接使用 kornia.geometry.conversions.rotation_matrix_to_quaternion
    # 或完整实现 Shepperd's algorithm
    return q